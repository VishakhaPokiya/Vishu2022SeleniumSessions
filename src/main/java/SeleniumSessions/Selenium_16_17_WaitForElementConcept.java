...
public class Selenium_16_17_WaitForElementConcept {
...
//		doSendKeys(username, "groupautomation", 10);
...
//		driver.findElement(loginBtn).click();
		...
		if(getElementTextListWithWait(footerLink, 5).contains("Partners"))
		{
	...
	public static List<String> getElementTextListWithWait(By locator,int timeOut)
	{
