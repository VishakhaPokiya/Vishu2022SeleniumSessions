...
public class Selenium_11_CustomXpath_1 {
...
//		3.xpath uses attribute(id,name,any)
...
//		<input id="firstname_456"/>
		...
		//input[@class='form-control private-form __control login-email']

		//class examples:

		By x1 = By.xpath("//input[@class='form-control private-form__control login-email']");//right
		By x2 = By.className("form-control private-form__control login-email");//wrong
